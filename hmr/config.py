...
MPII_ROOT = ''
COCO_ROOT = ''
UP_3D_ROOT = '../up-3d-test'

# Output folder to save test/train npz files
DATASET_NPZ_PATH = '../GraphCMR/datasets'
...
CUBE_PARTS_FILE = '../GraphCMR/data/cube_parts.npy'
JOINT_REGRESSOR_TRAIN_EXTRA = '../GraphCMR/data/J_regressor_extra.npy'
JOINT_REGRESSOR_H36M = '../GraphCMR/data/J_regressor_h36m.npy'
VERTEX_TEXTURE_FILE = '../GraphCMR/data/vertex_texture.npy'
SMPL_FILE = '../GraphCMR/data/basicModel_neutral_lbs_10_207_0_v1.0.0.pkl'
...
# Indices to get the 14 LSP joints from the 19 cocoplus joints
COCOPLUS_TO_LSP_KP = range(14)
